...
class TestRelu(TestCase):
    ...
    def test_complicated(self):
        t = AssemblyTest(self, "relu.s")
        # create an array in the data section
        array0 = t.array([1, -1, 4, -5, -1, 4, 0, 2, -9, 5, -2, 20])
        # load address of `array0` into register a0
        t.input_array("a0", array0)
        # set a1 to the length of our array
        t.input_scalar("a1", len(array0))
        ...
        t.call("relu")
        # check that the array0 was changed appropriately
        t.check_array(array0, [1, 0, 4, 0, 0, 4, 0, 2, 0, 5, 0, 20])
        # generate the `assembly/TestRelu_test_simple.s` file and run it through venus
        t.execute()
...
class TestArgmax(TestCase):
    def test_1(self):
        ...
        # create an array in the data section
        # TODO
        array0 = t.array([1, -1, 4, -5, -1, 4, 10, 2, -9, 5, -2])
    ...
    def test_2(self):
        ...
        # create an array in the data section
        # TODO
        array0 = t.array([-8,-12, 4, 10, -1, 9, 10, 2, -9, 10, -2])
        # load address of the array into register a0
        # TODO
        t.input_array("a0", array0)
        # set a1 to the length of the array
...
class TestDot(TestCase):
    def test_1(self):
        ...
        # TODO
        array0 = t.array([1, 1, 4, 5, 1, 4])
        array1 = t.array([3, 1, -4, 9, 2, 6])
